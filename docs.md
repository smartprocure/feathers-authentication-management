...
- reuseResetToken: Use the same reset token if user resets password twice in a short period of time. In this case token is not hashed in database. Default is false.
